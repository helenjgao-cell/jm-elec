...
const i18n = {
    zh: {
        ...
        filter_pct: '快速接线端子',
        filter_pt: 'PT导轨系列',
        filter_panel: '固定面板快速接线端子',
        filter_aviation: '防水航空插座',
        filter_heatshrink: '热缩管中间端子',
        filter_air: '空中对接快速接线端子',
        filter_through: '贯通式大电流端子',
        filter_wire_free: '免破线快速接线端子',
        filter_box_repair: '暗盒修复器',
        filter_crimp_box: '冷压端子+套盒',
        filter_spring_pt: '弹簧式PT导轨端子',
        filter_crimp: '冷压端子系列',
        filter_box_repair_series: '暗盒修复器系列',
        filter_wire_cap: '压线帽系列',
        filter_pcb_plug: '拔插式PCB端子',
        filter_pcb_screw: '螺钉式PCB端子',
        filter_pcb_fence: '栅栏式PCB端子',
        filter_pcb_spring: '免螺丝式PCB端子',
        filter_high_current: '大电流螺钉式端子',
        filter_handle: '手柄式快速接线端子',
        filter_mcs: 'MCS免螺丝接线端子',
        filter_uncategorized: '未分类',
        inquiry_btn: '立即询盘',
    ...
    en: {
        ...
        filter_panel: 'Panel Quick Connectors',
        filter_aviation: 'Waterproof Connectors',
        filter_heatshrink: 'Heat Shrink Terminals',
        filter_air: 'Air Quick Connectors',
        filter_through: 'Through-type High Current',
        filter_wire_free: 'Wire-free Quick Connectors',
        filter_box_repair: 'Box Repairer',
        filter_crimp_box: 'Crimp Terminals + Box',
        filter_spring_pt: 'Spring PT DIN Rail',
        filter_crimp: 'Crimp Terminal Series',
        filter_box_repair_series: 'Box Repairer Series',
        filter_wire_cap: 'Wire Cap Series',
        filter_pcb_plug: 'Plug-in PCB Terminals',
        filter_pcb_screw: 'Screw PCB Terminals',
        filter_pcb_fence: 'Fence PCB Terminals',
        filter_pcb_spring: 'Spring PCB Terminals',
        filter_high_current: 'High Current Screw Terminals',
        filter_handle: 'Handle Quick Connectors',
        filter_mcs: 'MCS Spring Terminals',
